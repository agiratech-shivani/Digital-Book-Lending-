...
})({"6hmXQ":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "76b8117d66b318b6";
"use strict";
...
},{}],"4OhJn":[function(require,module,exports) {
 ...
 */ class NestedAppAuthController {
    constructor(operatingContext){
        ...
        this.browserCrypto = operatingContext.isBrowserEnvironment() ? new (0, _cryptoOpsMjs.CryptoOps)(this.logger, this.performanceClient) : (0, _msalCommon.DEFAULT_CRYPTO_IMPLEMENTATION);
    ...
    async acquireTokenInteractive(request) {
        this.eventHandler.emitEvent((0, _eventTypeMjs.EventType).ACQUIRE_TOKEN_START, (0, _browserConstantsMjs.InteractionType).Popup, request);
        const atPopupMeasurement = this.performanceClient.startMeasurement((0, _msalCommon.PerformanceEvents).AcquireTokenPopup, request.correlationId);
    ...
    async acquireTokenSilentInternal(request) {
        ...
        const ssoSilentMeasurement = this.performanceClient.startMeasurement((0, _msalCommon.PerformanceEvents).SsoSilent, request.correlationId);
    ...
    getAccountByHomeId(homeAccountId) {
        ...
        if (currentAccount !== undefined) {
            if (currentAccount.homeAccountId === homeAccountId) return this.nestedAppAuthAdapter.fromNaaAccountInfo(currentAccount);
            else return null;
        } else return null;
    }
    getAccountByLocalId(localId) {
        const currentAccount = this.operatingContext.getActiveAccount();
        if (currentAccount !== undefined) {
            if (currentAccount.localAccountId === localId) return this.nestedAppAuthAdapter.fromNaaAccountInfo(currentAccount);
            else return null;
        } else return null;
    }
    getAccountByUsername(userName) {
        const currentAccount = this.operatingContext.getActiveAccount();
        if (currentAccount !== undefined) {
            if (currentAccount.username === userName) return this.nestedAppAuthAdapter.fromNaaAccountInfo(currentAccount);
            else return null;
        } else return null;
    }
    getAllAccounts() {
    ...
    loginPopup(request // eslint-disable-line @typescript-eslint/no-unused-vars
        ...
        if (request !== undefined) return this.acquireTokenInteractive(request);
        else throw (0, _nestedAppAuthErrorMjs.NestedAppAuthError).createUnsupportedError();
    }
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    getActiveAccount() {
        const currentAccount = this.operatingContext.getActiveAccount();
        if (currentAccount !== undefined) return this.nestedAppAuthAdapter.fromNaaAccountInfo(currentAccount);
        else return null;
    }
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    preflightBrowserEnvironmentCheck(interactionType, setInteractionInProgress // eslint-disable-line @typescript-eslint/no-unused-vars
    ) {
        throw (0, _nestedAppAuthErrorMjs.NestedAppAuthError).createUnsupportedError();
    }
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    async hydrateCache(// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
},{"@azure/msal-common":"rNWNa","../utils/BrowserConstants.mjs":"izeV4","../crypto/CryptoOps.mjs":"ftoka","../naa/mapping/NestedAppAuthAdapter.mjs":"dMnRV","../error/NestedAppAuthError.mjs":"lcyck","../event/EventHandler.mjs":"3FsXm","../event/EventType.mjs":"3AsqD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dMnRV":[function(require,module,exports) {
/*! @azure/msal-browser v3.10.0 2024-02-17 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ class NestedAppAuthAdapter {
    ...
    toNaaTokenRequest(request) {
        ...
        const requestBuilder = new (0, _msalCommon.RequestParameterBuilder)();
        ...
        const tokenRequest = {
            ...
            claims: !(0, _msalCommon.StringUtils).isEmptyObj(claims) ? claims : undefined,
            state: request.state,
            authenticationScheme: request.authenticationScheme || (0, _msalCommon.AuthenticationScheme).BEARER,
            extraParameters: extraParams
        };
        return tokenRequest;
    }
    fromNaaTokenResponse(request, response, reqTimestamp) {
        if (!response.token.id_token || !response.token.access_token) throw (0, _msalCommon.createClientAuthError)((0, _msalCommon.ClientAuthErrorCodes).nullOrEmptyToken);
        const expiresOn = new Date((reqTimestamp + (response.token.expires_in || 0)) * 1000);
        const idTokenClaims = (0, _msalCommon.AuthToken).extractTokenClaims(response.token.id_token, this.crypto.base64Decode);
        ...
        const authenticationResult = {
            ...
            fromCache: true,
            expiresOn: expiresOn,
            tokenType: request.authenticationScheme || (0, _msalCommon.AuthenticationScheme).BEARER,
     ...
     */ fromBridgeError(error) {
        if ((0, _bridgeErrorMjs.isBridgeError)(error)) switch(error.status){
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).UserCancel:
                return new (0, _msalCommon.ClientAuthError)((0, _msalCommon.ClientAuthErrorCodes).userCanceled);
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).NoNetwork:
                return new (0, _msalCommon.ClientAuthError)((0, _msalCommon.ClientAuthErrorCodes).noNetworkConnectivity);
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).AccountUnavailable:
                return new (0, _msalCommon.ClientAuthError)((0, _msalCommon.ClientAuthErrorCodes).noAccountFound);
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).Disabled:
                return new (0, _msalCommon.ClientAuthError)((0, _msalCommon.ClientAuthErrorCodes).nestedAppAuthBridgeDisabled);
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).NestedAppAuthUnavailable:
                return new (0, _msalCommon.ClientAuthError)(error.code || (0, _msalCommon.ClientAuthErrorCodes).nestedAppAuthBridgeDisabled, error.description);
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).TransientError:
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).PersistentError:
                return new (0, _msalCommon.ServerError)(error.code, error.description);
            case (0, _bridgeStatusCodeMjs.BridgeStatusCode).UserInteractionRequired:
                return new (0, _msalCommon.InteractionRequiredAuthError)(error.code, error.description);
            default:
                return new (0, _msalCommon.AuthError)(error.code, error.description);
        }
        else return new (0, _msalCommon.AuthError)("unknown_error", "An unknown error occurred");
    }
}

},{"@azure/msal-common":"rNWNa","../BridgeError.mjs":"iIlDT","../BridgeStatusCode.mjs":"7S8RS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iIlDT":[function(require,module,exports) {
/*! @azure/msal-browser v3.10.0 2024-02-17 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lcyck":[function(require,module,exports) {
/*! @azure/msal-browser v3.10.0 2024-02-17 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class NestedAppAuthError extends (0, _msalCommon.AuthError) {
...
},{"@azure/msal-common":"rNWNa","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6hmXQ"], null, "parcelRequirecc93")

//# sourceMappingURL=NestedAppAuthController.66b318b6.js.map
